...
export const testCredentials = {
  admin: [
    { email: 'admin@dropofhope.com', password: 'admin123', name: 'System Administrator' },
    { email: 'sarah.admin@dropofhope.com', password: 'admin123', name: 'Sarah Johnson' },
    { email: 'michael.admin@dropofhope.com', password: 'admin123', name: 'Michael Chen' },
  ],
  hospital: [
    { email: 'staff@cityhospital.com', password: 'hospital123', name: 'Dr. Emily Davis' },
    { email: 'coordinator@metromedical.com', password: 'hospital123', name: 'James Wilson' },
    { email: 'bloodbank@communityhc.com', password: 'hospital123', name: 'Dr. Lisa Rodriguez' },
  ],
  donor: [
    { email: 'donor@example.com', password: 'donor123', name: 'John Donor' },
    { email: 'mary.donor@example.com', password: 'donor123', name: 'Mary Smith' },
  ],
};
