...
export const AdminSetup = () => {
  ...
  const handleCreateAuthUsers = async () => {
    ...
    try {
      ...
      setResult({
        success: true,
        message: "Auth users creation initiated. Check console for details.",
      });
    } catch (error) {
      setResult({ success: false, error });
    } finally {
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-2 text-sm">
            ...
            <p>
              <strong>Step 2:</strong> Click "Create Auth Users" to create
              authentication users (requires proper Supabase configuration).
            </p>
            <p>
