...
export default function Rewards() {
  ...
  const nextLevel = levels.find(
    (level) => level.minPoints > mockUserProgress.currentPoints,
  );

  const progress = nextLevel
    ? ((mockUserProgress.currentPoints - currentLevel!.minPoints) /
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    {mockUserProgress.currentPoints} points •{" "}
                    {mockUserProgress.totalDonations} donations
                  </p>
                </div>
              </div>
              <div className="text-right">
                <div className="text-3xl font-bold text-hope-red">
                  {mockUserProgress.livesImpacted}
                </div>
                  ...
                  <div className="space-y-4">
                    <div className="text-center p-3 bg-hope-pink dark:bg-hope-coral rounded-lg">
                      <div className="text-2xl font-bold text-hope-red">
                        {mockUserProgress.totalDonations}
                      </div>
                      <div className="text-sm text-muted-foreground">
                        Total Donations
                      </div>
                    ...
                    <div className="text-center p-3 bg-hope-pink dark:bg-hope-coral rounded-lg">
                      <div className="text-2xl font-bold text-hope-red">
                        {mockUserProgress.consecutiveDonations}
                      </div>
                      <div className="text-sm text-muted-foreground">
                        Current Streak
                      </div>
                    ...
                    <div className="text-center p-3 bg-hope-pink dark:bg-hope-coral rounded-lg">
                      <div className="text-2xl font-bold text-hope-red">
                        #
                        {leaderboard.findIndex((user) => user.isCurrentUser) +
                          1}
                      </div>
                      <div className="text-sm text-muted-foreground">
                        Leaderboard Rank
