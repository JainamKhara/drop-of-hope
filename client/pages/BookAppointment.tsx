  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (error) {
        ...
        if (donorInfo.bloodType && donorInfo.bloodType !== profile?.blood_type) {
          await db.updateProfile(user.id, { blood_type: donorInfo.bloodType as any });
        }

        toast({
          title: "Appointment Booked!",
          description: "Your blood donation appointment has been successfully scheduled.",
        });
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-muted-foreground">Loading blood drive details...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          ...
          <Card className="mb-8 border-0 shadow-md">
            <CardHeader>
              <CardTitle className="text-2xl text-hope-red">{drive.name}</CardTitle>
              <p className="text-muted-foreground">
                Organized by {drive.profiles?.name || drive.hospitals?.name || "Unknown Organizer"}
              </p>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <p>{drive.start_time} - {drive.end_time}</p>
                  </div>
                </div>
          ...
          <Card className="border-0 shadow-md">
            ...
            <CardContent>
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <Select value={donorInfo.bloodType} onValueChange={(value) => setDonorInfo({...donorInfo, bloodType: value})}>
                        <SelectTrigger>
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => setDonorInfo({...donorInfo, dateOfBirth: e.target.value})}
                      />
                    </div>
              ...
              {step === 3 && (
                <div className="space-y-6">
                  <h3 className="text-lg font-semibold">Medical Information & Confirmation</h3>
                  
                  <div className="space-y-4">
                    <div>
                      <Label htmlFor="lastDonation">Date of Last Blood Donation</Label>
                      <Input
                        id="lastDonation"
                        type="date"
                        value={medicalInfo.lastDonation}
                        onChange={(e) => setMedicalInfo({...medicalInfo, lastDonation: e.target.value})}
                      />
                    </div>
                    ...
                    <div className="space-y-3">
                      <Label>Medical History (Check all that apply in the last 8 weeks)</Label>
                      
                      <div className="flex items-center space-x-2">
                        <Checkbox
                          id="recentTravel"
                          checked={medicalInfo.recentTravel}
                          onCheckedChange={(checked) => setMedicalInfo({...medicalInfo, recentTravel: !!checked})}
                        />
                        <Label htmlFor="recentTravel">Recent travel outside the country</Label>
                      </div>
                      ...
                      <div className="flex items-center space-x-2">
                        <Checkbox
                          ...
                          onCheckedChange={(checked) => setMedicalInfo({...medicalInfo, recentTattoo: !!checked})}
                        />
                        <Label htmlFor="recentTattoo">Recent tattoo or piercing</Label>
                      </div>
                      ...
                      <div className="flex items-center space-x-2">
                        <Checkbox
                          ...
                          onCheckedChange={(checked) => setMedicalInfo({...medicalInfo, recentIllness: !!checked})}
                        />
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <Label htmlFor="terms">
                        I agree to the{" "}
                        <Link to="/terms" className="text-hope-red hover:underline">
                  ...
                  <Card className="bg-hope-pink dark:bg-hope-coral">
                    <CardHeader>
                      <CardTitle className="text-hope-red">Appointment Summary</CardTitle>
                    </CardHeader>
                    <CardContent>
                      <div className="space-y-2">
                        <p><strong>Drive:</strong> {drive.name}</p>
                        <p><strong>Date:</strong> {selectedDate?.toLocaleDateString()}</p>
                        <p><strong>Time:</strong> {selectedTime}</p>
                        <p><strong>Location:</strong> {drive.location}</p>
                        <p><strong>Donor:</strong> {donorInfo.name}</p>
                        <p><strong>Blood Type:</strong> {donorInfo.bloodType || "Not specified"}</p>
                      </div>
                    </CardContent>
                  </Card>
