    ...
    <div className="min-h-screen bg-gradient-to-b from-hope-pink to-white dark:from-hope-coral dark:to-background">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              <Link
                to="/about"
                className="text-foreground hover:text-hope-red transition-colors"
              >
                About
              </Link>
              <Link
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto text-center">
          <Badge
            variant="secondary"
            className="mb-6 bg-hope-coral text-hope-red"
          >
            💧 Every Drop Counts
          </Badge>
          ...
          <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-3xl mx-auto">
            Connect donors with those in need. Save lives through the power of
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            {isSignedIn ? (
              <>
                <Button
                  size="lg"
                  className="bg-hope-red hover:bg-hope-red/90 text-lg px-8 py-3"
                  asChild
                >
                ...
                <Button
                  size="lg"
                  variant="outline"
                  className="text-lg px-8 py-3 border-hope-red text-hope-red hover:bg-hope-red hover:text-white"
                  asChild
                >
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <div key={index} className="text-center">
                ...
                <div className="text-3xl font-bold text-hope-red mb-2">
                  {stat.value}
                </div>
      ...
      <section className="py-20 px-4 bg-hope-pink dark:bg-hope-coral">
        <div className="container mx-auto text-center">
          <h2 className="text-4xl font-bold mb-6 text-hope-red">
          ...
          <Button
            size="lg"
            className="bg-hope-red hover:bg-hope-red/90 text-lg px-12 py-4"
            asChild
          >
