...
import { 
  Heart, ArrowLeft, Plus, MessageCircle, ThumbsUp, Share2, 
  Users, Calendar, Award, TrendingUp, Camera, Send,
  MapPin, Clock, Star, Trophy, Crown
} from 'lucide-react';
...
const communityPosts = [
  {
    ...
    content: '🩸 Just completed my 15th blood donation at City Hospital! Feeling amazing knowing I\'ve helped save 45 lives. The staff was incredible as always. Who\'s joining me for the next drive? #BloodDonation #DropOfHope',
    image: null,
    likes: 24,
    comments: 8,
    shares: 3,
  ...
  },
  {
    ...
    content: 'Amazing turnout at yesterday\'s university blood drive! 47 new donors joined our community. Special thanks to the volunteers who made this possible. Together we\'re making a difference! 💪',
    image: null,
    likes: 31,
    comments: 12,
    shares: 7,
  ...
  },
  {
    ...
    content: 'PSA: We\'re critically low on O- blood at our hospital. If you\'re an O- donor and eligible, please consider scheduling an appointment this week. Every donation can save up to 3 lives! 🚨',
    image: null,
    likes: 67,
    comments: 23,
    shares: 18,
...
const bloodTypeGroups = [
  { type: 'O+', members: 1247, description: 'Universal donors for positive blood types' },
  ...
  { type: 'AB-', members: 89, description: 'Can receive from all negative types' }
];

const leaderboard = [
  { rank: 1, name: 'Sarah Thompson', donations: 48, points: 4800, badge: 'Legend' },
  { rank: 2, name: 'Michael Chen', donations: 42, points: 4200, badge: 'Diamond' },
  { rank: 3, name: 'Dr. Emily Rodriguez', donations: 38, points: 3800, badge: 'Diamond' },
  { rank: 4, name: 'John Smith', donations: 34, points: 3400, badge: 'Platinum' },
  { rank: 5, name: 'Maria Garcia', donations: 29, points: 2900, badge: 'Platinum' }
];
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Connect with fellow donors, share your journey, and inspire others to save lives
          </p>
        </div>
                      ...
                      <div className="flex items-start space-x-3 mb-4">
                        ...
                        <div className="flex-1">
                          <div className="flex items-center space-x-2 mb-1">
                            ...
                            <Badge className={getBloodTypeColor(post.author.bloodType)}>
                              {post.author.bloodType}
                            </Badge>
                            <div className={`flex items-center space-x-1 ${getLevelColor(post.author.level)}`}>
                              {getLevelIcon(post.author.level)}
                              <span className="text-sm font-medium">{post.author.level}</span>
                            </div>
                          </div>
                          <div className="flex items-center space-x-4 text-sm text-muted-foreground">
                            <span>{post.author.donations} donations</span>
                            <span>{format(new Date(post.timestamp), 'MMM dd, yyyy • HH:mm')}</span>
                          </div>
                ...
                <Card className="border-0 shadow-lg">
                  ...
                  <CardContent className="space-y-3">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-xs text-muted-foreground">284 posts</span>
                    </div>
                    <div className="flex items-center justify-between">
                ...
                <Card className="border-0 shadow-lg">
                  ...
                  <CardContent className="space-y-3">
                    ...
                    <div className="text-center p-3 bg-hope-pink dark:bg-hope-coral rounded-lg">
                      ...
                      <div className="text-sm text-muted-foreground">Lives You've Saved</div>
                    </div>
                    <div className="text-center p-3 bg-hope-pink dark:bg-hope-coral rounded-lg">
          ...
          <TabsContent value="groups" className="space-y-6 mt-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {bloodTypeGroups.map((group) => (
                <Card key={group.type} className="border-0 shadow-lg hover:shadow-xl transition-shadow cursor-pointer">
                  <CardContent className="p-6 text-center">
                    <div className={`w-16 h-16 rounded-full mx-auto mb-4 flex items-center justify-center text-2xl font-bold ${getBloodTypeColor(group.type)}`}>
                      {group.type}
                    </div>
                    <h3 className="font-semibold text-lg mb-2">{group.members} Members</h3>
              ...
              <CardContent>
                <div className="space-y-4">
                  {leaderboard.map((user) => (
                    <div key={user.rank} className="flex items-center justify-between p-4 bg-hope-pink dark:bg-hope-coral rounded-lg">
                      <div className="flex items-center space-x-4">
                        <div className={`w-10 h-10 rounded-full flex items-center justify-center font-bold ${
                          ...
                          {user.rank <= 3 ? (
                            ...
                            user.rank === 2 ? <Award className="w-5 h-5" /> :
              ...
              <Card className="border-0 shadow-lg">
                <CardContent className="p-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      <h3 className="font-semibold mb-2">Community Blood Drive</h3>
                ...
                <CardContent className="p-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      ...
                      <Button size="sm" className="mt-3" variant="outline">Learn More</Button>
                    </div>
                  </div>
                </CardContent>
              </Card>
